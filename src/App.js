...
function MovieDetails() {
  ...
  useEffect(() => {
    fetch(`https://63899fec4eccb986e895aacd.mockapi.io/ratingapp/${id}`, {
      method: "GET",
    })
...
function Error() {
  return (
    <div>
      ...
      <img
        className="err"
        src="https://www.bing.com/th/id/OGC.87bb2b84e94654e1a2efe66910814c9a?pid=1.7&rurl=https%3a%2f%2fgobarrelroll.com%2fwp-content%2fuploads%2f2018%2f09%2f404-error.gif&ehk=hEBYJM8%2fRfK17XSeZG9DgNf%2bAvyBC%2fEyf7HnHFhFtrA%3d"
        alt=""
      />
    </div>
  );
